...
1. Close the milestone: Edit the [milestone](https://github.com/10up/convert-to-blocks/milestone/#) with release date (in the `Due date (optional)` field) and link to GitHub release (in the `Description` field), then close the milestone.
